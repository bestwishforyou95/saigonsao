...
/*
	if(isset($_SESSION['Zend_Auth']["storage"]->taikhoan_nguoidung_access))
	{
		if (($_SESSION['Zend_Auth']["storage"]->taikhoan_nguoidung_access == 'admin') || ($_SESSION['Zend_Auth']["storage"]->taikhoan_nguoidung_access == 'staft')){
			return true;
		}else{
			return false;
		}
